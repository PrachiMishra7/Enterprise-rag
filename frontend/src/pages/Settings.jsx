...
export default function SystemSettings() {
  const [apiKey, setApiKey] = useState('gsk_yF8jW9Lâ€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢');
    ...
    <div className="flex-1 flex flex-col bg-slate-50 dark:bg-background text-slate-900 dark:text-foreground overflow-y-auto relative">
      ...
      <div className="max-w-4xl mx-auto w-full p-6 md:p-10 relative z-10 space-y-8">
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          {/* API Key Config */}
          <div className="bg-white/[0.02] border border-slate-200 dark:border-border rounded-3xl p-6 md:p-8 space-y-6">
            <h3 className="text-md font-black uppercase tracking-wider text-slate-700 dark:text-muted-foreground flex items-center gap-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                <input 
                  ...
                  className="w-full pl-4 pr-12 py-3 bg-slate-100 dark:bg-secondary border border-slate-200 dark:border-border rounded-xl text-xs font-semibold focus:outline-none focus:border-indigo-500/50 text-slate-900 dark:text-foreground font-mono"
                />
                <button 
                  onClick={() => setShowKey(!showKey)}
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-700 dark:text-muted-foreground hover:text-slate-900 dark:text-foreground"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col gap-2">
                <div className="flex justify-between text-[10px] font-bold text-[#8b92a5] uppercase tracking-wider">
                  ...
                  <span className="text-slate-900 dark:text-foreground font-mono">{chunkSize}</span>
                </div>
                <input 
              ...
              <div className="flex flex-col gap-2">
                <div className="flex justify-between text-[10px] font-bold text-[#8b92a5] uppercase tracking-wider">
                  ...
                  <span className="text-slate-900 dark:text-foreground font-mono">{chunkOverlap}</span>
                </div>
                <input 
              ...
              <div className="flex flex-col gap-2">
                <div className="flex justify-between text-[10px] font-bold text-[#8b92a5] uppercase tracking-wider">
                  ...
                  <span className="text-slate-900 dark:text-foreground font-mono">{topK}</span>
                </div>
                <input 
              ...
              <div className="flex flex-col gap-2">
                <div className="flex justify-between text-[10px] font-bold text-[#8b92a5] uppercase tracking-wider">
                  ...
                  <span className="text-slate-900 dark:text-foreground font-mono">{(minSimilarity * 100).toFixed(0)}%</span>
                </div>
                <input 
          ...
          <div className="bg-white/[0.02] border border-slate-200 dark:border-border rounded-3xl p-6 md:p-8 space-y-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <select className="w-full px-3 py-3 bg-[#0a0f1d] border border-slate-200 dark:border-border rounded-xl text-xs font-semibold focus:outline-none focus:border-indigo-500/50 text-slate-900 dark:text-foreground">
